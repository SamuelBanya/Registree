...
<2023-10-23 Mon 18:52>: I then created a new 'RegistreeController' with this command:
#+begin_src bash
dotnet add package Microsoft.VisualStudio.Web.CodeGeneration.Design --version 7.0.12

dotnet tool install -g dotnet-aspnet-codegenerator

dotnet controller scaffold RegistreeController -m Registree -dc RegistreeContext --useAsyncActions --relativeFolderPath Controllers
#+end_src
