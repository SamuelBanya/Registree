...
** In Progress
*** IN-PROGRESS Model 'Registry Wizard Menu' components after related Figma
...
<2023-10-17 Tue 20:41>: I had to follow this .NET based GitHub issues page to figure out how to install .NET 7.0 on Linux Mint:
...
I then finally did this command:
#+begin_src bash
sam@devstation ~/hub/repos/Registree/registree/RegistreeAPI $ dotnet ef migrations add InitialCreate
Build started...
Build succeeded.
Unable to create an object of type 'RegistreeContext'. For the different patterns supported at design time, see https://go.microsoft.com/fwlink/?linkid=851728
#+end_src

At this point, I will have to figure out how to install Postgres on Linux Mint accordingly, and hook it up to the backend.
